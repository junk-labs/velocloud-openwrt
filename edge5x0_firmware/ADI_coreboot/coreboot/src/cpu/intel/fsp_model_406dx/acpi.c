...
/* TODO Fix ACPI	lenif += generate_cstate_entries(cpu->cstates, conf->c1_acpower,
...
/* TODO fix ACPI	len += generate_cstate_entries(cpu->cstates, conf->c1_battery,
...
static int generate_P_state_entries(int core, int cores_per_package)
{
	...
	/* TODO - Rangeley doesn't have this MSR. Assume hardware only control */
	coord_type = HW_ALL;
