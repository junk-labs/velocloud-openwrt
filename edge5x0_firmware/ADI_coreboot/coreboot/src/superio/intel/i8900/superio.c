...
static void i8900_init(device_t dev)
{
	if (!dev->enabled)
		return;
}

static void i8900_pnp_set_resources(device_t dev)
{
...
static void i8900_pnp_enable_resources(device_t dev)
{
	pnp_enter_ext_func_mode(dev);
...
static void i8900_pnp_enable(device_t dev)
{
	pnp_enter_ext_func_mode(dev);
