...
MICROCODE_VERSION=20140122
MICROCODE_DIRECTORY=23574
MICROCODE_ARCHIVE=microcode-$MICROCODE_VERSION.tgz
MICROCODE_FILE=microcode.dat
INTEL_MICROCODE=http://downloadmirror.intel.com/$MICROCODE_DIRECTORY/eng/$MICROCODE_ARCHIVE
