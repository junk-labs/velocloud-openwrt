...
const struct irq_routing_table intel_irq_routing_table = {
	...
	0x86,		 /* u8 checksum. */
	{
		...
		{0x00,(0x02<<3)|0x0, {{PIRQA, PCI_IRQS}, {PIRQB, PCI_IRQS}, {PIRQC, PCI_IRQS}, {PIRQD, PCI_IRQS}}, 0x0, 0x0}, // PCIE Port 2: INTA-PIRQD, INTB-PIRQC, INTC-PIRQB, INTD-PIRQA
		...
		{0x00,(0x04<<3)|0x0, {{PIRQH, PCI_IRQS}, {PIRQG, PCI_IRQS}, {PIRQF, PCI_IRQS}, {PIRQE, PCI_IRQS}}, 0x0, 0x0}, // PCIE Port 4: INTA-PIRQH, INTB-PIRQG, INTC-PIRQF, INTD-PIRQE
