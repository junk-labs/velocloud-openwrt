...
const struct soc_gpio soc_gpio_mode = {
	.gpio15 = GPIO_MODE_GPIO, /* GPIO Output to PIC, PIC_PRG_MCLR_N */
	.gpio16 = GPIO_MODE_GPIO, /* GPIO Output to PIC. PIC_PRG_CLK */
	.gpio17 = GPIO_MODE_GPIO, /* GPIO Output/Input to/from PIC. PIC_PRG_DATA  */
};
...
const struct soc_gpio soc_gpio1_mode = {
#if IS_ENABLED(CONFIG_GPIO_TPM)
	.gpio8  = GPIO_MODE_GPIO, /* bit banged I2C SCL in place of iSMT */
	.gpio9  = GPIO_MODE_GPIO, /* bit banged I2C SDA in place of iSMT */
	.gpio10 = GPIO_MODE_GPIO, /* bit banged I2C ALRT# in place of iSMT */
#endif
...
const struct soc_gpio soc_gpio1_direction = {
#if IS_ENABLED(CONFIG_GPIO_TPM)
	.gpio8  = GPIO_DIR_INPUT,  /* bit banged I2C SCL in place of iSMT */
	.gpio9  = GPIO_DIR_INPUT,  /* bit banged I2C SDA in place of iSMT */
	.gpio10 = GPIO_DIR_INPUT,  /* bit banged I2C ALRT# in place of iSMT */
#endif
	.gpio15 = GPIO_DIR_INPUT, 
	.gpio16 = GPIO_DIR_OUTPUT, 
...
const struct soc_gpio soc_gpio1_level = {
        .gpio15 =  GPIO_LEVEL_LOW,
	.gpio16 =  GPIO_LEVEL_HIGH,
...
const struct soc_cfio soc_cfio_core[] = {
	...
	{ 0xc4a8, 0x30003, 0x0002, 0x040c },  /* CFIO gpios_10 SMB_ALRT_N0 */
	{ 0xc4a8, 0x30003, 0x0002, 0x040c },  /* CFIO gpios_13 SMB_DAT2 */
	{ 0xc4a8, 0x30003, 0x0000, 0x040c },  /* CFIO gpios_14 SMB_CLK2 */
	{ 0xc4a8, 0x30003, 0x0002, 0x040c },  /* CFIO gpios_11 SMB_DAT1 */
	{ 0xc4a8, 0x30003, 0x0000, 0x040c },  /* CFIO gpios_8 SMB_CLK0 */
	{ 0xc4a8, 0x30003, 0x0002, 0x040c },  /* CFIO gpios_9 SMB_DAT0 */
	{ 0xc4a8, 0x30003, 0x0000, 0x040c },  /* CFIO gpios_12 SMB_CLK1 */
...
const struct soc_gpio soc_gpio_sus_mode  = {
	.gpio1 = GPIO_MODE_GPIO, /*GPIO Output to TPM. TPM_PP Physical Presence */
	.gpio2 = GPIO_MODE_GPIO, /*GPIO Input from PIC. Function TBD */
	.gpio6 = GPIO_MODE_GPIO, /*GPIO Output to SIM. SIM Select. */
	.gpio17 = GPIO_MODE_GPIO, /*GPIO Input from 88E1543 - Interrupt */
};
...
const struct soc_gpio_map gpio_map1 = {
        .core = {
                .mode      = &soc_gpio1_mode,
                .direction = &soc_gpio1_direction,
                .level     = &soc_gpio1_level,
                .tpe       = &soc_gpio_tpe,
                .tne       = &soc_gpio_tne,
                .ts        = &soc_gpio_ts,
                .cfio_init = &soc_cfio_core[0],
