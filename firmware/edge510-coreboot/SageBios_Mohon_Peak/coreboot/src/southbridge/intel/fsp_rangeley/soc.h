...
/* Temp SATA ABAR addresses (matched with FSP)*/
#define DEFAULT_SATA2_ABASE	0xF0200000
#define DEFAULT_SATA3_ABASE	0xF0300000
...
#define SATA_CMD_REG		0x04
# define SATA_MEM_SPACE_ENABLE	(1 << 1)
#define SATA_ABAR_REG		0x24
#define SATA_SIRI		0xa0 /* SATA Indexed Register Index */
#define SATA_SIRD		0xa4 /* SATA Indexed Register Data */
#define SATA_SP			0xd0 /* Scratchpad */
#define SATA_MAP		0x90
# define SATA_MODE_SELECT_SHIFT		6
# define SATA_MODE_SELECT_MASK		(~ (0x03 << SATA_MODE_SELECT_SHIFT))
# define SATA_MODE_AHCI			1
#define SATA_PSC		0x92


/* GHC_CAP (GHC_CAP)—Offset 0h values */
#define GHC_CAP_REG		0x00
#define GHC_CAP_ISS_SHIFT	20
#define GHC_CAP_ISS_MASK	( ~ (0x0FUL << GHC_CAP_ISS_SHIFT))
...
#define CFIO_UART0_RXD  0x160
#define CFIO_UART0_TXD  0x170
